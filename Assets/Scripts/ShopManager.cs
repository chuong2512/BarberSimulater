...
public class ShopManager : MonoBehaviour
{
    ...
    private sealed class _BuyDiamond_c__AnonStorey3
    {
        ...
        internal void __m__0()
        {
            ...
            Notification.instance.Warning("Received <color=#00FFDFFF>" +
    ...
    private void LoadDefaultBoostProductPrice()
    {
        ...
        {
            GameUtilities.String.ToText(this.boostProduct[i].valueLabel,
    ...
    {
        this.shopRectransform.anchoredPosition = new Vector2(this.shopRectransform.anchoredPosition.x,
